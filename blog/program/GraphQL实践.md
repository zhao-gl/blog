...
image: https://img.zhaogl.me/320f3e5a66900d68e93de38154989948.png
---
...
![](https://img.zhaogl.me/9a7412200a062646b729c8419be28b35.jpeg)

### Restful API

Restful 架构的设计范式侧重于分配 HTTP 请求方法（GET、POST、PUT、PA TCH、DELETE）和 URL 端点之间的关系。如下图

![](https://img.zhaogl.me/17fc41e2de8d829dc2d41e31a0775df3.png)
...
![](https://img.zhaogl.me/Y4u9tNpZwR.png)
...
![](https://img.zhaogl.me/8a141ec5fa73781d66fb2e1b60f9b49d.jpg)
...
![](https://img.zhaogl.me/Z0b6ya-auG.png)
...
仓库本文实例代码仓库： [zhaogl/nest-graphql-demo](https://github.com/zhaogl/nest-graphql-demo 'zhaogl/nest-graphql-demo')
...
![](https://img.zhaogl.me/a3yl4oVtSU.png)

此时点击执行，可以得到右侧结果，即`app.resolver.ts` 中 `hello` 函数所定义的返回体。

![](https://img.zhaogl.me/bK9bvZ3QMm.png)
...
![](https://img.zhaogl.me/L9yYAn78Dw.png)
...
![](https://img.zhaogl.me/XemqTcfz_D.png)
...
![](https://img.zhaogl.me/sJCQpllOXK.png)
...
![](https://img.zhaogl.me/7-twN56Aym.png)
...
![](https://img.zhaogl.me/NPqShDN3Pl.png)

#### 修改

![](https://img.zhaogl.me/c4ycwRs-po.png)

#### 删除

![](https://img.zhaogl.me/xpkHhpS1-K.png)
...
这里我就选用 [zhaogl/vitesse-nuxt-strapi](https://github.com/zhaogl/vitesse-nuxt-strapi 'zhaogl/vitesse-nuxt-strapi') 作为演示，并为其提供 graphQL 支持。
...
![](https://img.zhaogl.me/4GFUs8CmQJ.png)

#### 查询 id 为 2 的 todo

![](https://img.zhaogl.me/NMM4e3L_y8.png)

#### 查询 id 为 2 的 todo 并只返回 value 属性

![](https://img.zhaogl.me/E1eWrzjaEs.png)

#### 新增 todo

![](https://img.zhaogl.me/pclR7Zb6TE.png)

#### 更新 todo

![](https://img.zhaogl.me/g3RJL7RQWR.png)

#### 删除 todo

![](https://img.zhaogl.me/m7s17q2TG0.png)
