...
image: https://img.zhaogl.me/trpc-banner.png
...
在线体验地址：[TRPC demo](https://trpc.zhaogl.me/)
...
![image-20230308142331808](https://img.zhaogl.me/20230308142331808.png)
...
![image-20230308142452678](https://img.zhaogl.me/20230308142452678.png)
...
![](https://img.zhaogl.me/YDKc7TixQA.png)
...
![](https://img.zhaogl.me/WfW8ehqUKz.png)

![](https://img.zhaogl.me/qicvoGjshx.png)
...
调用 `trpc.greeting.useQuery({ name: 'zhaogl' })` 发送的请求的 query 参数则变为

![](https://img.zhaogl.me/20230307214659.png)

不仅于此，你如果同时调用了多次 greeting 函数，如

```typescript title='pages/index.tsx'
const result1 = trpc.greeting.useQuery({ name: 'zhaogl1' })
const result2 = trpc.greeting.useQuery({ name: 'zhaogl2' })
const result3 = trpc.greeting.useQuery({ name: 'zhaogl3' })
```

tRPC 会将这三次函数调用合并成一次 http 请求，并且得到的响应本文也是以多条数据的形式返回

![](https://img.zhaogl.me/ufrhaugaIj.png)

![](https://img.zhaogl.me/cvlDJjhwPl.png)

分别输出三者 result 也没有任何问题。

![](https://img.zhaogl.me/hbL8So_RzB.png)
...
![](https://img.zhaogl.me/-qEI8jR1uM.png)

![](https://img.zhaogl.me/RTdWJn_55p.png)
...
![](https://img.zhaogl.me/8BUcBPK8In.png)
...
![](https://img.zhaogl.me/ERGzEt2Tq8.png)
...
![](https://img.zhaogl.me/QBXnHdoewh.png)
...
![](https://img.zhaogl.me/_B1RYeiFze.png)
...
export const authOptions: NextAuthOptions = {
  ...
  providers: [
    CredentialsProvider({
      name: 'Credentials',
      credentials: {
        username: { label: 'Username', type: 'text', placeholder: 'zhaogl' },
        password: { label: 'Password', type: 'password' },
      },
      async authorize(credentials, req) {
        // Add logic here to look up the user from the credentials supplied
        const user = { id: '1', name: 'zhaogl', email: 'hi@zhaogl.me' }
...
![](https://img.zhaogl.me/9eowvvnwU2.png)
...
![](https://img.zhaogl.me/7_XKmbuK87.png)
...
这里我提供了一个简单的示例，你可以 [点我](https://trpc.zhaogl.me) 访问体验一下（项目部署在 Vercel，而数据库服务在腾讯云，登录服务又依赖 Github，所以项目会稍微有那么慢）。整个项目结构大致如下

![](https://img.zhaogl.me/z_YaR-RnSu.png)
