...
演示代码地址：[zhaogl/spring-boot-demo (github.com)](https://github.com/zhaogl/spring-boot-demo)

## 目录结构展示图

![](https://img.zhaogl.me/20220108011921.png)
...
![image-20220506115207717](https://img.zhaogl.me/20220506115207717.png)
...
一般情况下该接口无需定义额外方法，如有需要还可以定义属于自己的查询语句，比如上面的 findByUsername，这时候就注入后的 userRepository 对象就可以使用`userRepository.findByUsername("zhaogl");` ，将会返回数据库中该用户名的数据。
...
```java title="service/UserService.java"
import com.zhaogl.demo.domain.User;
import com.zhaogl.demo.repository.UserRepository;
import com.zhaogl.demo.service.UserService;
