...
演示地址：[KzAdmin](https://admin.zhaogl.me) 管理员账号：admin 密码：123456

<!-- truncate -->

![image-20220505171231754](https://img.zhaogl.me/20220505171231754.png)

## 前端

**基于[Vben Admin](https://vvbin.cn/doc-next/)开发，使用 Vue3、Vite、TypeScript 等最新技术栈，内置常用功能组件、权限验证、动态路由。**

仓库地址：https://github.com/zhaogl/kz-vue-admin
...
仓库地址：https://github.com/zhaogl/kz-nest-admin
...
![image-20220508235534026](https://img.zhaogl.me/20220508235534026.png)
...
![image-20220508234343594](https://img.zhaogl.me/20220508234343594.png)
...
在[菜单管理页](https://admin.zhaogl.me/#/system/menu)中可操作菜单，具体可自测。

至此，菜单表的数据被拆分为这 3 部分数据，以实现权限管理，动态路由的目的。

#### 其他文档

你可以访问 [https://admin.zhaogl.me/swagger-ui](https://admin.zhaogl.me/swagger-ui 'https://admin.zhaogl.me/swagger-ui') 来查看 nest-vben-admin 的 Swagger 文档

json 格式为 [https://admin.zhaogl.me/swagger-ui/json](https://admin.zhaogl.me/swagger-ui/json 'https://admin.zhaogl.me/swagger-ui/json')，用于导入 ApiFox 中。
