...
tags: [rust, wasm]
keywords: [rust, wasm]
image: https://img.zhaogl.me/202312270251453.png
---
...
这里我所借用 [rwasm/vite-plugin-rsw](https://github.com/rwasm/vite-plugin-rsw) 插件，在 vite 中配合 wasm-pack 进行开发的一个实例。代码部分就不做解读了，有兴趣可自行到翻阅源码：[zhaogl/rust-wasm-md5](https://github.com/zhaogl/rust-wasm-md5)

在线地址：[http://rust-wasm-md5.zhaogl.me](http://rust-wasm-md5.zhaogl.me/) （不保证地址长期可用）

![](https://img.zhaogl.me/_XHPNCbC-B.png)

## 思考：为何不使用 js 的 md5 而是 wasm 的 md5

众所周知，你在浏览器中按下 F12 打开 DevTools，并选择源代码面板中就可以看到当前访问的网站的所有代码。

![](https://img.zhaogl.me/6019y_U19n.png)

而对于一些具有熟练度的逆向分析者中，如果不经过任何处理的代码被打包到生产环境中能够快速的定位出某个功能的具体代码位置。

而通过 wasm 就能很有效的将代码隐藏起来，不让逆向分析者查看，就像下面这样

![](https://img.zhaogl.me/BbA3n6wFws.png)

![](https://img.zhaogl.me/81tgfDE_P7.png)
