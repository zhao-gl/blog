...
基于 Babel 对 JS 代码进行混淆与还原操作的网站 [JS 代码混淆与还原 (zhaogl.me)](http://deobfuscator.zhaogl.me/)

![js-de-obfuscator](https://github.com/zhaogl/js-deobfuscator/blob/main/images/1.png)
...
贴上代码 git 地址 [js-de-obfuscator/example/deobfuscator/cx](https://github.com/zhaogl/js-de-obfuscator/blob/main/example/deobfuscator/cx/code.js)
...
![image-20211224202108279](https://img.zhaogl.me/20211224202108279.png)
...
具体的实例可通过 [源码例子](https://github.com/zhaogl/js-de-obfuscator/tree/main/example/deobfuscator) 中查看对 AST 的操作。
...
针对上述还原操作其实还不够明显，于是就编写了一个在线对 JS 代码混淆与还原的网站（主要针对还原）– [JS 代码混淆与还原 (zhaogl.me)](https://deobfuscator.zhaogl.me/)
